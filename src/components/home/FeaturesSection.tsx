  ...
  return (
    <>
      ...
      <div className="mt-24 flex justify-center md:mt-30">
        <div className="grid grid-cols-1 place-items-center lg:grid-cols-3 lg:gap-x-8">
          <div className="h-full w-80 rounded-xl border border-dark-800 bg-dark-900 shadow-md">
          ...
          <div className="flex h-full flex-col lg:gap-y-8">
            <div className="w-80 rounded-xl border border-dark-800 bg-dark-900 shadow-md">
              <div className="flex flex-col p-8">
                <div className="flex h-18 w-18 items-center justify-center rounded-lg bg-blue-500">
            ...
            <div className="flex h-full w-80 items-center justify-center rounded-xl border border-dark-800 bg-dark-900 shadow-md">
